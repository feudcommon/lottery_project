        ...
        <div className="space-y-4">
          ...
          {stats && (
            <div className="bg-white rounded-lg shadow p-4">
              ...
              <div className="space-y-2 text-sm">
                <div><span className="text-gray-600">Total earned:</span> <span className="font-bold">{stats.totalEarned}</span></div>
                <div><span className="text-gray-600">Tickets bought:</span> <span className="font-bold">{stats.ticketsPurchased}</span></div>
                <div><span className="text-gray-600">Spins done:</span> <span className="font-bold">{stats.spinsCompleted}</span></div>
              </div>
            </div>
          )}
